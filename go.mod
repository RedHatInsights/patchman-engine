...
require (
	...
	github.com/RedHatInsights/patchman-clients/inventory v0.0.0-20191205080343-d3fd25e923bf
	github.com/RedHatInsights/patchman-clients/vmaas v0.0.0-20191205080343-d3fd25e923bf
