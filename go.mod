...
require (
	...
	github.com/RedHatInsights/patchman-clients/inventory v0.0.0-20191212132059-056583055ff3
	github.com/RedHatInsights/patchman-clients/vmaas v0.0.0-20191212132059-056583055ff3
