...
func GetEvaluatorUploadPprof(c *gin.Context) {
	param := c.Param("param")
	data, err := getPprof(c, utils.Cfg.EvaluatorUploadPrivateAddress, param)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"err": err.Error()})
		return
	}
...
func GetEvaluatorRecalcPprof(c *gin.Context) {
	param := c.Param("param")
	data, err := getPprof(c, utils.Cfg.EvaluatorRecalcPrivateAddress, param)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"err": err.Error()})
		return
	}
...
func GetListenerPprof(c *gin.Context) {
	param := c.Param("param")
	data, err := getPprof(c, utils.Cfg.ListenerPrivateAddress, param)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"err": err.Error()})
		return
	}
...
func GetManagerPprof(c *gin.Context) {
	param := c.Param("param")
	data, err := getPprof(c, utils.Cfg.ManagerPrivateAddress, param)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"err": err.Error()})
		return
	}
...
func getPprof(c *gin.Context, address, param string) ([]byte, error) {
	client := &http.Client{
