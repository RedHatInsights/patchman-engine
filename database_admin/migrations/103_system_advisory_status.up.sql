...
UPDATE status SET name = 'Installable' WHERE id = 0;
UPDATE status SET name = 'Applicable' WHERE id = 1;

UPDATE system_advisories SET status_id = 0;
ALTER TABLE system_advisories ALTER COLUMN status_id DROP DEFAULT,
