UPDATE status SET name = 'Not Reviewed' WHERE id = 0;
UPDATE status SET name = 'In-Review' WHERE id = 1;
...
ALTER TABLE system_advisories ALTER COLUMN status_id DROP NOT NULL,
                              ALTER COLUMN status_id SET DEFAULT 0;

ALTER TABLE advisory_account_data RENAME COLUMN systems_applicable TO status_id;
ALTER TABLE advisory_account_data RENAME COLUMN systems_installable TO systems_affected;
