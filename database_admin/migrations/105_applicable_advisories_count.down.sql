REVOKE UPDATE (installable_advisory_count_cache,
              installable_advisory_enh_count_cache,
              installable_advisory_bug_count_cache,
              installable_advisory_sec_count_cache), DELETE ON system_platform FROM manager;
REVOKE UPDATE (applicable_advisory_count_cache,
              applicable_advisory_enh_count_cache,
              applicable_advisory_bug_count_cache,
              applicable_advisory_sec_count_cache), DELETE ON system_platform FROM manager;

ALTER TABLE system_platform RENAME COLUMN installable_advisory_count_cache TO advisory_count_cache;
ALTER TABLE system_platform RENAME COLUMN installable_advisory_enh_count_cache TO advisory_enh_count_cache;
ALTER TABLE system_platform RENAME COLUMN installable_advisory_bug_count_cache TO advisory_bug_count_cache;
ALTER TABLE system_platform RENAME COLUMN installable_advisory_sec_count_cache TO advisory_sec_count_cache;
ALTER TABLE system_platform DROP COLUMN applicable_advisory_count_cache,
                            DROP COLUMN applicable_advisory_enh_count_cache,
                            DROP COLUMN applicable_advisory_bug_count_cache,
                            DROP COLUMN applicable_advisory_sec_count_cache;
