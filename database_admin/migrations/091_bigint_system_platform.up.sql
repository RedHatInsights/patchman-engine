 -- estimation: Time: 85236.905 ms (01:25.237)
ALTER TABLE system_platform ALTER COLUMN id TYPE BIGINT,
                            ALTER COLUMN baseline_id TYPE BIGINT;

-- count system advisories according to advisory type
DROP FUNCTION IF EXISTS system_advisories_count(system_id_in INT, advisory_type_id_in INT);
...
DROP FUNCTION IF EXISTS refresh_system_caches(system_id_in INTEGER, rh_account_id_in INTEGER);
...
DROP FUNCTION IF EXISTS update_system_caches(system_id_in INT);
