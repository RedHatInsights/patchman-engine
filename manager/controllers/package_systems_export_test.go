...
func TestPackageSystemsExportHandlerJSON(t *testing.T) {
	...
	assert.Equal(t, "0:5.6.13-200.fc31.x86_64", output[0].InstalledEVRA)
	assert.Equal(t, "0:5.10.13-200.fc31.x86_64", output[0].AvailableEVRA)
...
func TestPackageSystemsExportHandlerCSV(t *testing.T) {
	...
	assert.Equal(t, "00000000-0000-0000-0000-000000000012,00000000-0000-0000-0000-000000000012,"+
		"0:5.6.13-200.fc31.x86_64,0:5.10.13-200.fc31.x86_64,true,\"[{'key':'k1','namespace':'ns1','value':'val1'}]\",,",
		lines[1])
	assert.Equal(t, "00000000-0000-0000-0000-000000000013,00000000-0000-0000-0000-000000000013,"+
		"0:5.6.13-200.fc31.x86_64,,false,\"[{'key':'k1','namespace':'ns1','value':'val1'}]\",,", lines[2])
}
